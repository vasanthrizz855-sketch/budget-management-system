...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">{{ $item->customer_name }}</h1>
        <p class="text-muted mb-0">Customer code: {{ $item->customer_code }}</p>
    </div>
    <a href="{{ route('admin.customers.edit', $item) }}" class="btn btn-primary">Edit Customer</a>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-6">
        <div class="card soft-card">
            <div class="card-body">
                <h5 class="mb-3">Sales Invoice History</h5>
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        @forelse($item->salesInvoices as $invoice)
                            <tr>
